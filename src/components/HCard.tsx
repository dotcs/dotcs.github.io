        ...
        <div className="flex flex-row gap-4 p-2">
            ...
            <div>
                ...
                <div className="mb-4">
                    ...
                    {props.nickname && (
                        <span>
                            (<span className="p-nickname">{props.nickname}</span>)
                        </span>
                    )}
                </div>
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-inside list-disc ml-2">
                        {props.url && (
                            <li>
                                <a className={cx('u-url', { 'u-uid': props.main })} href={props.url}>
                                    web
                                </a>
                            </li>
                        )}
                ...
                <ul className="block">
                    {props.locality && (
                        <li className="inline-block">
                            <span className="p-locality">{props.locality}</span>,
                        </li>
                    )}
                    {props.region && (
                        <li className="inline-block ml-1">
                            <abbr className="p-region" title={props.region?.title}>
                                {props.region?.abbr}
                            </abbr>
                            ,
                        </li>
                    ...
                    {props.country && (
                        <li className="inline-block ml-1">
                            <span className="p-country-name">{props.country}</span>
                        </li>
                    )}
                </ul>
